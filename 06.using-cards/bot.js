...
var cat = {};
cat.jt = [
    'https://i.imgflip.com/2uawgq.jpg',
    'https://i.imgflip.com/2uawgq.jpg',
    'https://i.imgflip.com/2uawgq.jpg',
    'https://i.imgflip.com/2uawgq.jpg',
    'https://i.imgflip.com/2uawgq.jpg'
...
cat.paro = [
    'http://m.memegen.com/2eur3s.jpg',
    'http://m.memegen.com/2eur3s.jpg',
    'http://m.memegen.com/2eur3s.jpg',
    'https://ep01.epimg.net/verne/imagenes/2017/06/27/mexico/1498590454_658193_1498601981_sumario_normal.jpg',
    'https://ep01.epimg.net/verne/imagenes/2017/06/27/mexico/1498590454_658193_1498601981_sumario_normal.jpg'
]
cat.empanada = [
    'http://www.quickmeme.com/img/b3/b38d56cba04529cf4211ded305434c76b000a98ddf36d64e4f9b5b76535f8582.jpg',
    'http://www.quickmeme.com/img/b3/b38d56cba04529cf4211ded305434c76b000a98ddf36d64e4f9b5b76535f8582.jpg',
    'http://www.quickmeme.com/img/b3/b38d56cba04529cf4211ded305434c76b000a98ddf36d64e4f9b5b76535f8582.jpg',
    'https://memegenerator.net/img/instances/74100721/empanada-o-plomo.jpg',
    'https://memegenerator.net/img/instances/74100721/empanada-o-plomo.jpg'
]
cat.nacho = [
    'http://www.quickmeme.com/img/d6/d606a49ef06fe1c013ecc58a40bbcaff652e49fbc33019d81d45d55c12c38a5e.jpg',
    'http://www.quickmeme.com/img/d6/d606a49ef06fe1c013ecc58a40bbcaff652e49fbc33019d81d45d55c12c38a5e.jpg',
    'http://www.quickmeme.com/img/d6/d606a49ef06fe1c013ecc58a40bbcaff652e49fbc33019d81d45d55c12c38a5e.jpg',
    'http://www.quickmeme.com/img/d6/d606a49ef06fe1c013ecc58a40bbcaff652e49fbc33019d81d45d55c12c38a5e.jpg',
    'http://www.quickmeme.com/img/d6/d606a49ef06fe1c013ecc58a40bbcaff652e49fbc33019d81d45d55c12c38a5e.jpg'
...
cat.clasicos = [
    'https://pics.me.me/sale-a-buscar-trabajo-lo-encuentra-jajajajajajja-don-ramon-xd-9577959.png',
    'https://pics.me.me/sale-a-buscar-trabajo-lo-encuentra-jajajajajajja-don-ramon-xd-9577959.png',
    'https://pics.me.me/sale-a-buscar-trabajo-lo-encuentra-jajajajajajja-don-ramon-xd-9577959.png',
    'https://pics.me.me/sale-a-buscar-trabajo-lo-encuentra-jajajajajajja-don-ramon-xd-9577959.png',
    'https://pics.me.me/sale-a-buscar-trabajo-lo-encuentra-jajajajajajja-don-ramon-xd-9577959.png'
...
class RichCardsBot {
    ...
    async sendCardResponse(turnContext, dialogTurnResult) {
        if( dialogTurnResult.result.value in cat ) 
            await turnContext.sendActivity({ attachments: [this.createHeroCard(dialogTurnResult.result.value)] });
        else 
            await turnContext.sendActivity({ attachments: [this.createHeroCard("nomeme")] });    
    ...
    getChoices() {
        const cardOptions = [
            {
                value: 'jt',
                synonyms: ['jhon', 'travolta', 'jt']
            },
            {
                value: 'paro',
                synonyms: ['paro', 'mamerto', 'feminazi']
            },
            {
                value: 'empanada',
                synonyms: ['empanada', 'policia', 'multa', 'vededores ambulates']
            },
            {
                value: 'nacho',
                synonyms: ['nacho', 'UP', 'Universidad Nacional']
            },
            {
                value: 'clasicos',
                synonyms: ['clasicos', 'clasic', 'thumbnail card']
            }
        ];
    ...
    createHeroCard(categoria) {
        return CardFactory.heroCard(
            'BotFramework Hero Card',
            CardFactory.images( [ cat[categoria][ 0 ] ] ),
            CardFactory.actions([
                {
                    type: 'openUrl',
                    title: 'Get started',
